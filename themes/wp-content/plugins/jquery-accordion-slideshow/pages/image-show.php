  ...
  <div id="icon-edit" class="icon32 icon32-posts-post"></div>
	...
	<?php
      ...
      <table width="100%" class="widefat" id="straymanage">
		...
		<p class="description"><?php _e('Note: Dont upload your original images into plug-in folder. if you upload the images into plug-in folder, you may lose the images when you update the plug-in to next version.', 'jquery-accordion-slideshow'); ?></p>
		<?php wp_nonce_field('JaS_form_show'); ?>
		<input type="hidden" name="frm_JaS_display" value="yes"/>
      </form>	
	  <div class="tablenav">
	  <h2>
	  <a class="button add-new-h2" href="<?php echo WP_JaS_ADMIN_URL; ?>&amp;ac=add"><?php _e('Add New', 'jquery-accordion-slideshow'); ?></a>
	  <a class="button add-new-h2" target="_blank" href="<?php echo Wp_JaS_FAV; ?>"><?php _e('Help', 'jquery-accordion-slideshow'); ?></a>
	  </h2>
	  </div>
	  <div style="height:5px"></div>
	<h3><?php _e('Plugin configuration option', 'jquery-accordion-slideshow'); ?></h3>
	<ol>
		<li><?php _e('Drag and drop the widget to your sidebar.', 'jquery-accordion-slideshow'); ?></li>
